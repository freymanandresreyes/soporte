...
<body class="skin-blue fixed-layout">
    ...
    <div class="container">
      ...
      <div class="col-12 img-error">
        <img class="img-responsive" src="{!! asset('assets/images/error/500.png') !!}" alt="">
      </div>
        <div class="col-12">
            <div class="error-body text-center">

                <h3 class="text-uppercase">500 Error!</h3>
                <p class="text-muted m-t-30 m-b-30">ERROR INTERNO DEL SERVIDOR.</p>
